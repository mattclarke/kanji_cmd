cards = {
    ...
    10: ("竹", 'BAMBOO', "チク, たけ", "[The blue CHICK (チク)] weaved its way between two BAMBOO.", "Bamboo"),
    ...
    16: (
        ...
        "ツ, ツウ, とお-る, かよ-う, とお-す",
        "With a `chop-seal> in one hand and a `screwdriver> in the other, he motioned the TRAFFIC down the `road> [with a yippee-KAYOU (かよ-う)].",
        "",
    ),
    17: ("弟", "YOUNGER BROTHER", "ダイ, テイ, デ, おとうと", "[OTTO (おとうと)], my YOUNGER BROTHER used to wear `horns> on his head and a `dollar sign> around his neck.", ""),
